...
Import with rename (`import { PI as π }`) solves naming conflicts. If you already have a PI variable in your module, you can import the math module's PI as a different name. This is also useful for creating more convenient or descriptive names.
